...
export default function Preview() {
  return (
    <section className="bg-gray-900 px-4 py-6 text-center sm:px-8 md:py-16">
      <div className="mx-auto max-w-7xl py-24 lg:flex lg:flex-row lg:items-center lg:justify-center lg:gap-12">
        ...
        <div className="flex flex-col">
          ...
          <h3 className="text-3xl font-semibold text-white xs:text-4xl sm:text-5xl md:text-6xl lg:text-5xl lg:tracking-tighter xl:text-7xl">
