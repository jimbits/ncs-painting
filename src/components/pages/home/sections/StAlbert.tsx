...
export default function StAlbert() {
  return (
    <section className="mx-auto max-w-7xl">
      <div className="relative mx-auto mb-28 grid grid-cols-1 grid-rows-[auto] items-center bg-white lg:grid-cols-2 lg:gap-8 dark:bg-gray-900">
        <div className="mx-4 place-items-center overflow-hidden rounded-xl bg-gray-400 lg:max-w-[600px]">
          <img
          ...
          <div className="pr-6 pl-6 lg:p-0">
            <header className="sm:text-center lg:text-left">
              <h2 className="text-base/7 font-semibold text-pretty text-indigo-600 dark:text-indigo-400">
                Local House Painters in St. Albert.
              </h2>
              <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl dark:text-white">
                Residential Home Painting Specialists
              </p>
              <p className="mt-6 max-w-3xl text-base/7 text-gray-600 sm:mx-auto dark:text-gray-300">
